    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900 p-4 lg:flex-row lg:items-center">
        ...
        <div className="flex flex-wrap gap-2">
          <button type="button" onClick={() => { setSearch(''); void load() }} className="rounded-xl border border-slate-700 px-4 py-2 text-sm hover:bg-slate-800">Đặt lại</button>
